...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/apps/apps/binapps/anaconda3/2021.11/lib/
...
# python main.py --is_training 1 --model TiDE --loss mse --devices $CUDA_VISIBLE_DEVICES
python script.py